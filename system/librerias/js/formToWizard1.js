...
(function($) {
    $.fn.formToWizard = function(options) {
        ...
        function createNextButton(i) {
            var stepName = "step" + i;
            $("#" + stepName + "commands").append("<button style='float:right' type='button' id='" + stepName + "Next' class='next btn btn-primary btn-sm'>Siguiente <span class='glyphicon glyphicon-chevron-right'></span></button>");
