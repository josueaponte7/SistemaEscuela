...
!function(a, b) {
    ...
    p.alert = function() {
        ...
        var a, d, e, f, h, i, k;
        f = b(n.form), d = {className: "bootbox-prompt", buttons: l("confirm","cancel"), value: "", inputType: "text"}, a = m(j(d, arguments, ["title", "callback"]), ["cancel", "confirm"]), i = a.show === c ? !0 : a.show;
