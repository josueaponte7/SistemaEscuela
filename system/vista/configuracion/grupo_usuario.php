...
$resul_grupoUsu = $obj_grupoUsu->getGrupo($d_grupoUsu);


$_SESSION['menu']        = 'configuracion_grupo_usuario';
$_SESSION['dir_sys']     = 'configuracion';
$_SESSION['archivo_sys'] = 'grupo_usuario';
...
<html>
    <head>
        ...
        <script type="text/javascript" src="../../librerias/script/grupo_usuario.js"></script>
    </head>
    <body>  
        <div id="reporte_grupo" style="display: block;margin: auto;padding-bottom: 80px;">
            <fieldset>
                <legend class="letras_label"> 
                    Listado de Grupo de Usuario
                </legend>
            </fieldset>
            <button type="button" id="registrar" class="btn btn-primary btn-sm" style="margin-left: 650px;" >Registrar Grupo</button>
            <br/>
            <br/>
            <br/>
            <br/>
            <div style="width: 95%;margin-left: auto;margin-right: auto">
                <table style="width:100%;" border="0" class="dataTable" id="tabla_grupo" align="center" name="tabla_grupo">
                    <thead>
                        <tr class="letras">
                            <th style="margin-left: 20px !important;" width="81">
                                <input type="checkbox" name="todos" id="todos" value="todos" />
                            </th>
                            <th style="width: 35%">Codigo Grupo</th>
                    ...
                    <tbody>
                        <?php
                         $es_array = is_array($resul_grupoUsu) ? TRUE : FALSE;
                        if($es_array === TRUE){
                        for ($i = 0; $i < count($resul_grupoUsu); $i++) {
                            ?>
                        <tr class="letras">
                                <td>
                                    <input type="checkbox" id="<?php echo $resul_grupoUsu[$i]['id_grupo']; ?>" name="id_grupo[]" value="<?php echo $resul_grupoUsu[$i]['id_grupo']; ?>" />
                                </td>
                                <td><?php echo $resul_grupoUsu[$i]['id_grupo']; ?></td>                            
                                <td><?php echo $resul_grupoUsu[$i]['nombre_grupo']; ?></td>
                                <td style="text-align: center">
                                    <img class="modificar" src="../../imagenes/edit.png" title="Modificar" style="cursor: pointer"  width="18" height="18" alt="Modificar"/>
                                </td>
                                <td style="text-align: center">
                                    <?php 
                                    if($resul_grupoUsu[$i]['id_grupo'] > 1){
                                    ?>
        ...
        <div id="registro_grupo" style="display: none">
            <form id="frmgrupo_usuario"  name="frmgrupo_usuario" role="form">
                <div class="panel panel-default" style="width : 97%;margin: auto;height: auto;position: relative;">
                    <div class="panel-heading letras_titulos">Grupo Usuario</div>
                    <div class="panel-body">
                        <table width="376" border="0" align="center" style="margin-top: 25px;">                         
                            <tr>
                                <td width="90" class="letras"> Nombre del Grupo</td>
                                <td width="276"  align="center">
                                    <div id="div_grupo" class="form-group">
                                        <input  type="text" class="form-control  input-sm" id="nombre_grupo" name="nombre_grupo" placeholder="Nombre del Grupo"/>
                                    </div>
                                </td>
                            </tr>
                            <tr>
