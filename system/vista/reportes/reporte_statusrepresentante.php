...
$campos['campos'] = 'erep.id_estatus,  erep.nombre';
$resultado       = $obj->getStrep($campos);
$total = $obj->totalFilas('estatus_representante','id_estatus',$campos['condicion']);
...
// titulo del listado
$titulo = "LISTADO DE ESTATUS REPRESENTANTE";
$pdf->Ln(5);
$pdf->SetX(60);
...
$pdf->Output('listado_estatusRepresentante.pdf', 'I');
