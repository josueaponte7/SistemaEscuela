...
$obj        = new StatusChofer();
$campos['campos'] = 'esch.id_estatus,  esch.nombre';
$resultado       = $obj->getStchof($campos);
$total = $obj->totalFilas('estatus_chofer','id_estatus',$campos['condicion']);
...
// titulo del listado
$titulo = "LISTADO DE ESTATUS CHOFER";
$pdf->Ln(5);
$pdf->SetX(60);
...
$pdf->Output('listado_estatusChofer.pdf', 'I');
