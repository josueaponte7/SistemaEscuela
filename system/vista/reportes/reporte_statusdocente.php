...
$campos['condicion'] = 1;
$id_condicion        = 'id_estatus';
if(isset($_GET['id'])){
    $id = $_GET['id'];
    $campos['condicion'] = " id_estatus IN($id)";
}

/* * ****Se inicia el objeto de estatus estudiante****** */
$obj        = new StatusDocente();
$campos['campos'] = 'esdoc.id_estatus, esdoc.nombre';
$resultado       = $obj->getStdoc($campos);
$total = $obj->totalFilas('estatus_docente','id_estatus',$campos['condicion']);
...
// titulo del listado
$titulo = "LISTADO DE ESTATUS DOCENTE";
$pdf->Ln(5);
$pdf->SetX(60);
...
$pdf->Output('listado_estatusDocente.pdf', 'I');
