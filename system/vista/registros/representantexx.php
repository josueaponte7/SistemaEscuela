                    ...
                    <table width="887" border="0" align="center">                        
                        ...
                        <tr>
                            ...
                            <td  width="5" heigth="10">
                                <img style="cursor: pointer; margin-left: -40px;" id="imgsector" src="../../imagenes/exclamtion.png" width="15" height="15" alt="img_info"/>
                            </td>
                            ...
                            <td width="272">
                             ...
                             <td  width="5" heigth="10">
                                <img style="cursor: pointer; margin-top: -20px;" id="imgsector" src="../../imagenes/exclamtion.png" width="15" height="15" alt="img_info"/>
                            </td>
                        </tr>
                        <tr height="60">
                            ...
                            <td  width="5" heigth="10">
                                <img style="cursor: pointer; margin-top: -15px; margin-left: -38px;" id="imgsector" src="../../imagenes/exclamtion.png" width="15" height="15" alt="img_info"/>
                            </td>
                            ...
                            <td  width="5" heigth="10">
                                <img style="cursor: pointer; margin-top: -8px;" id="imgsector" src="../../imagenes/exclamtion.png" width="15" height="15" alt="img_info"/>
                            </td>
                        </tr>
                        <tr height="40">
                        ...
                        <tr height="60">
                            ...
                            <td  width="5" heigth="10">
                                <img style="cursor: pointer; margin-top: -16px;" id="imgsector" src="../../imagenes/exclamtion.png" width="15" height="15" alt="img_info"/>
                            </td>
                        </tr>
                        <tr>
