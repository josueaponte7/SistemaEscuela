...
$datos_re['sql'] = "SELECT 
                    ...
                    CONCAT_WS('-',(SELECT codigo FROM codigo_telefono  WHERE id=r.cod_telefono),r.telefono) AS telefono,
                    e_r.parentesco,
                    e_r.representante
                        ...
                        if (cedula_old != cedula_new) {
                            $.post("../../controlador/Estudiante.php", {cedula: cedula_alum,cedula_representante: cedula_new, accion: 'UpRepre'}, function(respuesta) {
                                if (respuesta == 1) {
                                    ...
                                    $iframe.find('table#tabla_estudiante tbody tr:eq(' + fil_old + ')').find("td:eq(3)").find('span').text(nombre);
                                    $iframe.find('table#tabla_estudiante tbody tr:eq(' + fil_old + ')').find("td:eq(3)").find('span').attr('id',cedula_new);
                            ...
                            <tbody>
                                ...
                                for ($i = 0; $i < count($resultado); $i++) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $resultado[$i]['parentesco'] ?></td>
