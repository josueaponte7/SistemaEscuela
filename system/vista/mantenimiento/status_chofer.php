<?php
session_start();
require_once '../../modelo/StatusChofer.php';
$obj_statusCho = new StatusChofer();

$d_statusch['campos'] = 'esch.id_estatus,  esch.nombre';
$resul_statusch = $obj_statusCho->getStchof($d_statusch);

$_SESSION['menu']        = 'mantenimiento_status_choefer';
$_SESSION['dir_sys']     = 'mantenimiento';
$_SESSION['archivo_sys'] = 'status_chofer';
...
<html>
    <head>
        ...
        <script type="text/javascript" src="../../librerias/script/status_chofer.js"></script>
    </head>
    <body>  
        <div id="reporte_statuschof" style="display: block;margin: auto;padding-bottom: 80px;">
            <fieldset>
                <legend class="letras_label"> 
                    Listado de Status del Chofer
                </legend>
            </fieldset>
            ...
            <div style="width: 95%;margin-left: auto;margin-right: auto">
                <table style="width:100%;" border="0" class="dataTable" id="tabla_statuschof" align="center" name="tabla_statuschof">
                    <thead>
                        <tr class="letras">
                    ...
                    <tbody>
                        <?php
                        $es_array = is_array($resul_statusch) ? TRUE : FALSE;
                        if($es_array === TRUE){
                        for ($i = 0; $i < count($resul_statusch); $i++) {
                            ?>
                            <tr class="letras">
                                <td>
                                    <input type="checkbox" id="<?php echo $resul_statusch[$i]['id_estatus']; ?>" name="id_estatus[]" value="<?php echo $resul_statusch[$i]['id_estatus']; ?>" />
                                </td>
                                <td><?php echo $resul_statusch[$i]['id_estatus']; ?></td>                            
                                <td><?php echo $resul_statusch[$i]['nombre']; ?></td>
        ...
        <div id="registro_statuschof" style="display: none">
            <form id="frmstatus_chofer"  name="frmstatus_chofer" role="form">
                <div class="panel panel-default" style="width : 97%;margin: auto;height: auto;position: relative;">
                    <div class="panel-heading letras_titulos">Status del Chofer</div>
                    <div class="panel-body">
                        <table width="376" border="0" align="center" style="margin-top: 25px;">                         
                            <tr>
                                <td width="90" class="letras"> Status Chofer </td>
                                <td width="276"  align="center">
                                    <div id="div_statusch" class="form-group">
